...
interface Props { isCardSelected: boolean, toggleModal?: any, pokemonId: number, offset: number }
interface PokemonData {
    // Define the properties of the PokemonData type here
    stats?: any; // Replace 'any' with the actual type of the 'stats' property
  }

const DetailPage = ({ isCardSelected, toggleModal, pokemonId, offset }: Props) => {
    ...
    const [data, setPokemonData] = useState<PokemonData | undefined>({ stats: undefined });
    const [isDetailLoading, setLoading] = useState(true);
    const [isModalOpen, setCloseModal] = useState(isCardSelected);
    const [pokemonSpeciesData, setPokemonSpeciesData] = useState<PokemonData | undefined>(undefined);
    const [pokemonTypeData, setPokemonTypeData] = useState<PokemonData | undefined>({ stats: undefined });
